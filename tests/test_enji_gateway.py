...
class _GatewayHarness:
    def __init__(self) -> None:
        ...
        self.gateway = AuditGateway(auth_file=self.auth_file, client=self.client, auth_port=StoredCredentialReader())
...
def test_audit_gateway_task_detail_maps_real_http_helper_failures(
    ...
    gateway = AuditGateway(auth_file=auth_file, client=client, auth_port=StoredCredentialReader())
