...
DEFAULT_AUTO_REFRESH_LEAD_SECONDS = 480
...
DEFAULT_TRANSPORT_RESPECT_RETRY_AFTER_HEADER = True
    ...
    return EnjiGuardSettings(
        ...
        transport=TransportSettings(
            ...
            retry=TransportRetrySettings(
                ...
                respect_retry_after_header=DEFAULT_TRANSPORT_RESPECT_RETRY_AFTER_HEADER,
            ),
